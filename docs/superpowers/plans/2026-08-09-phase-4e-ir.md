...
After 4b-M, `emptyloop` passes exit criterion 4 (IR 3.12x against the tree-walker's 3.13x) and **`varlookup` fails it** at IR 4.28x against 4.21x -- IR/TW 1.016, the IR arm slower in nine pairs out of nine, samples non-overlapping. Both arms improved against the anchor's 3.33x and 4.40x.
