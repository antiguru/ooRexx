...
### Task 2: `Op`, `Chunk`, the register allocator, and the chunk cache
...
The register allocator, even though nothing allocates yet -- later tasks must not invent a second one:
...
The loop's control registers allocate in the enclosing scope, before the member clauses are emitted, per the register discipline above.
...
- [ ] **Step 7: Measure, interleaved, both arms of the same binary**
...
- [ ] **Step 8: Falsify any claimed speedup by reverting**

- [ ] **Step 9: Record predicted versus measured, and commit**
