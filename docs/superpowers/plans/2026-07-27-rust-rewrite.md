...
which is what section 6's Phase 8 bullet requires of this phase (`:2638`, *"open a decision block
for it before writing the `extern "C"` entry points"*).
