...
* **D23.** The trace setting is an input to compilation, realised as explicit trace instructions in the stream. Divergent trace output is licensed only from the first optimising pass that is not trace-neutral, priced at Phase 9.
