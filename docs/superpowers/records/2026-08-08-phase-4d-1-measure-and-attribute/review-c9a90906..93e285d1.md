# Review package: 4d-1 Task 3

Range c9a90906..93e285d1

## Commits
93e285d1 Diagnose the unbounded loop retention: two causes, not one

## Stat
 docs/superpowers/plans/phase-4-exclusions.txt |  68 +++++
 docs/superpowers/plans/phase-4d-diagnosis.md  |   9 +
 docs/superpowers/plans/phase-4d-retention.md  | 386 ++++++++++++++++++++++++++
 3 files changed, 463 insertions(+)

## Diff
diff --git a/docs/superpowers/plans/phase-4-exclusions.txt b/docs/superpowers/plans/phase-4-exclusions.txt
index f906235c..85ac9a1d 100644
--- a/docs/superpowers/plans/phase-4-exclusions.txt
+++ b/docs/superpowers/plans/phase-4-exclusions.txt
@@ -2455,10 +2455,78 @@ fix were removed. Removing a row here needs the same amendment a KNOWN GAP does.
...
index 9206b0ea..4105db58 100644
