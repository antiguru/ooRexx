...
DECLARED = set(os.environ.get("SPLIT_DECLARED", "impl ObjectModel::fn build|struct ObjectModel|const WEAK_REFERENT|fn native_class_copy|tests::fn a_metaclass_with_its_own_new_is_loud").split("|")) - {""}
