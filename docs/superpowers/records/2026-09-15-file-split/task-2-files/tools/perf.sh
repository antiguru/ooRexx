#!/bin/bash
# usage: perf.sh BASE_BIN HEAD_BIN OUTDIR JOBS
...
mkdir -p $OUT/cwd
PROGS="$R/bench-rexxcps/rexxcps.rex $R/bench-programs/dispatch.rex $R/bench-programs/dispatchclass.rex $R/bench-programs/varlookup.rex $R/bench-programs/arith.rex $R/bench-programs/compound.rex $R/bench-programs/alloc.rex $R/bench-programs/strings.rex"
jobs=()
