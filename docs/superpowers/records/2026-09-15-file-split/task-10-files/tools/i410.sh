#!/bin/bash
# usage: i410.sh N
# i410.sh for Task 10: the test worktree at the main checkout's HEAD plus
# snapshot N, run_tests10.sh, and the comparison with BASE's results.
...
$S/tools/run_tests10.sh $S/wt $S/art/i4-c$N
