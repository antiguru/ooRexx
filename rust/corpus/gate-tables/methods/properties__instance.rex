/* Table C method rows: Properties, instance arm -- one line per method
   corpus/docs/class-methods.txt documents on this arm, asked of the
   instance `.Properties~new` answers, in the row set's own order. That
...
say 'instance' o~hasMethod("getLogical")
say 'instance' o~hasMethod("getProperty")
say 'instance' o~hasMethod("getWhole")
say 'instance' o~hasMethod("load")
say 'instance' o~hasMethod("put")
say 'instance' o~hasMethod("save")
say 'instance' o~hasMethod("setLogical")
say 'instance' o~hasMethod("setProperty")
say 'instance' o~hasMethod("setWhole")
say 'instance' o~hasMethod("[]")
