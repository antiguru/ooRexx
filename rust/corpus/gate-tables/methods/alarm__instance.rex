/* Table C method rows: Alarm, instance arm -- one line per method
   corpus/docs/class-methods.txt documents on this arm, asked of the
   instance `.Alarm~new(99999, .Message~new(.Object~new, 'STRING'))~~cancel` answers, in the row set's own order. That
...
o = .Alarm~new(99999, .Message~new(.Object~new, 'STRING'))~~cancel
...
say 'instance' o~hasMethod("scheduledTime")
