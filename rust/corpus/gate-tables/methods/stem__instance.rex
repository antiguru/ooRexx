/* Table C method rows: Stem, instance arm -- one line per method
   corpus/docs/class-methods.txt documents on this arm, asked of the
   instance `.Stem~new` answers, in the row set's own order. That
...
say 'instance' o~hasMethod("toDirectory")
