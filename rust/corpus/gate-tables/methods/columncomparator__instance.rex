/* Table C method rows: ColumnComparator, instance arm -- one line per method
   corpus/docs/class-methods.txt documents on this arm, asked of the
   instance `.ColumnComparator~new(3, 100)` answers, in the row set's own order. That
