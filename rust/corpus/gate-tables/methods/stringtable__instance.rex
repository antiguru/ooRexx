/* Table C method rows: StringTable, instance arm -- one line per method
   corpus/docs/class-methods.txt documents on this arm, asked of the
   instance `.StringTable~new` answers, in the row set's own order. That
...
say 'instance' o~hasMethod("entry")
say 'instance' o~hasMethod("hasEntry")
...
say 'instance' o~hasMethod("removeEntry")
say 'instance' o~hasMethod("removeItem")
say 'instance' o~hasMethod("setEntry")
