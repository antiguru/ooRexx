/* Table C method rows: CaselessDescendingComparator, instance arm -- one line per method
   corpus/docs/class-methods.txt documents on this arm, asked of the
   instance `.CaselessDescendingComparator~new` answers, in the row set's own order. That
...
o = .CaselessDescendingComparator~new
