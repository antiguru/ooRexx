/* Table C wiring row: the .CaselessDescendingComparator environment entry, asked what it
...
say 'entry' .CaselessDescendingComparator
say 'class-of-entry' .CaselessDescendingComparator~class~id
