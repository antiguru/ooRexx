/* extracted from SourceFile::test_logicalNot04 */
::routine main public

    fileSrc = .array~new
    fileSrc[1]  = "ret = 9"
    fileSrc[2]  = "day = 'friday'"
    fileSrc[3]  = "if 'friday ' �== day then do"    -- Note extra space in friday
    ...
    self~assertTrue(output[1] == "it is not friday", "Program output must be correct")

  -- Test using � in an expression when true
::class shim public
::method assertEquals
