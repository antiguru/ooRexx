/* extracted from Ticker::test_ticker_three_args_string_trigger_message */
::routine main public
  t1 = .tickerWaiter~new
  ...
  -- cancel the Ticker before there is a chance that any assert will fail
  -- (see also comment in TickerWaiter triggered method)
  ticker~cancel
