/* extracted from circularqueue::test_5 */
::routine main public
   ...
   self~assertEquals('Tom', que[3])
   self~assertEquals('Tony', que[4])
   self~assertEquals('Bill', que[5])
   self~assertEquals(.nil, que[6])
   que~queue('Linda')
   self~assertEquals('David', que[1])
   self~assertEquals('Tom', que[2])
   self~assertEquals('Tony', que[3])
   self~assertEquals('Bill', que[4])
   self~assertEquals('Linda', que[5])
   self~assertEquals(.nil, que[6])
