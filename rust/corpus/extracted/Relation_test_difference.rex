/* extracted from Relation::test_difference */
::routine main public
  ...
  o1=.object~new
  c =clz~new~~put("<1-value>", "1")~~put("<2-value>", "2")~~put("<o1-value>", o1)~~put("a","a")
  other=.array~new
  other[104]="2"
  other[106]=o1
  other[107]="a"
                 -- expected result
  d1=clz~new~~put("<1-value>", "1")~~put("<2-value>", "2")~~put("<o1-value>", o1)
