/* extracted from Set::test_subset */
::routine main public
  ...
  -- Some simplistic subset tests where the arguement object is a table.
  ...
  argumentTable["Mary"]  = "Mary"
  self~assertTrue(receiverSet~subset(argumentTable), "Set of Tom Frank Mary is subset of Tom Frank Sue Mary")

  receiverSet~put("Nancy")
  self~assertFalse(receiverSet~subset(argumentTable), "Set of Tom Frank Mary Nancy is NOT subset of Tom Frank Sue Mary")
