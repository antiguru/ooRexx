/* A library-backed EXTERNAL reports its declaring package. A loadExternal*
   answer shares the library's code object for that procedure spelling: its
   package is .nil until a directive binds the procedure and the first binder's
   afterwards, for an object answered before the binding too. */
