/* FORWARD's four value-carrying options, and the three defaults it fills in
   ...
   replacing what the callee sees. A bare FORWARD, which would take all three
   at once, is the shape corpus/oracle-crashes.txt names and is not here. */
t = .Target~new
o = .K~new
say 'to' o~m(t)
