/* ADDRESS naming an environment: the constant form, the two computed forms,
   ...
   The environment an ADDRESS instruction sets has exactly four readers, and
   ...
   An engine that traced a value for the constant form prints three extra
   lines; one that evaluated the computed form without tracing it prints two
   fewer.
