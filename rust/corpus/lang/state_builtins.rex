/* The builtins that read interpreter state: ARG, CONDITION, DIGITS, FORM,
   ...
   OFF at F1, and it also resurrects a trap the handler turned off. The
   condition does not survive the handler's return, which F3 is: an engine
   keeping one interpreter-wide condition object prints USER UC there.
