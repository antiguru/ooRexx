 ...
 *
 * No other ::CONSTANT witness can tell "nearest preceding" from "last in
 * file" apart: none has a ::CLASS directive following the failing constant,
 * the only shape the two rules disagree on. This program does:
