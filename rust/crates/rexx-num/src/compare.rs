...
pub fn compare(a: &str, b: &str, digits: u32, fuzz: u32, op: CompareOp) -> Result<bool, ArithError> {
    if op.is_strict() {
...
fn numeric_order(a: &Number, b: &Number, digits: u32, fuzz: u32) -> Result<Ordering, ArithError> {
