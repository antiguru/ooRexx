...
use table_c::probes::{
    CLASS_SUBDIR, CONCEPT_SUBDIR, DOCUMENTED_EDGE_MARKER, EDGE_SUBDIR, ENTRY_MARKER, METHOD_SUBDIR,
    class_probe, class_probe_class_questions, class_probe_entry_questions, class_probe_text,
    concept_probe, derived_say_lines, edge_probe, edge_probe_text, method_probe, method_probe_text,
};
use table_c::rows::{
    ClassRow, Construction, Edge, Section, read_classes, read_edges, read_method_rows,
    read_sections,
};
