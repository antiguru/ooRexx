...
//! `corpus/lang/stem_object.rex` against the oracle, on both engines.
//!
...
const PROGRAM: &str = "corpus/lang/stem_object.rex";
...
/// harness that does.
#[test]
fn the_stem_object_program_answers_the_oracle() {
